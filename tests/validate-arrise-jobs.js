/**
 * ARRISE Job Validator - Check and remove expired jobs
 * 
 * Validates all ARRISE jobs from peviitor API and deletes expired (404) ones from SOLR.
 * Run: node tests/validate-arrise-jobs.js
 */
...
const COMPANY_NAME = "ARRISE SERVICES S.R.L.";

/**
 * Get all jobs for ARRISE from peviitor API
 */
...
async function main(args) {
  ...
  console.log("ARRISE Job Validator");
  console.log("=".repeat(50));
